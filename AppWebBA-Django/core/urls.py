...
from .views import home, administrar_productos, tienda, ficha_view
from .views import iniciar_sesion, registrar_usuario, cerrar_sesion
from .views import perfil_usuario, iniciar_pago, pago_exitoso, obtener_solicitudes_de_servicio, contact_view
...
urlpatterns = [
    ...
    path('', home, name="home"),
    path('iniciar_pago/<int:idprod>', iniciar_pago, name="iniciar_pago"),
