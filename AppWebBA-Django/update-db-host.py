...
ruta_settings = r"E:\BuenosAires\AppWebBA-Django\AppWebBA\settings.py"
...
# Ahora usa la variable en el f-string SIN backslashes dentro
contenido = re.sub(r"'HOST':\s*'[^']*'", f"'HOST': '{nuevo_host_django}'", contenido)
...
carpeta_bodega = r"E:\BuenosAires\BodegaBA-CSharp"
